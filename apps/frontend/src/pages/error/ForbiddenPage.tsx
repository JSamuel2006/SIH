  ...
  return (
    <PublicLayout>
      <div className="max-w-md mx-auto my-20 p-8 bg-slate-900 border border-slate-800 rounded-2xl text-center shadow-2xl">
        ...
        <h1 className="text-3xl font-extrabold text-slate-100">403 - Access Denied</h1>
        <p className="text-xs text-slate-400 mt-2 leading-relaxed">
          You do not have the required Role-Based Access Control (RBAC) privileges to view this Public Health Officer or Admin resource.
        </p>
        <Link
          to="/"
